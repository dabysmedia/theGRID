...
export const CATEGORY_THEME: Record<CategoryKey, CategoryTheme> = {
  ...
  workouts: { key: "workouts", label: "Workouts", href: "/", icon: Dumbbell, color: "#c4d632", unit: "sessions", description: "Log your sessions" },
  ...
  weight: { key: "weight", label: "Weight", href: "/", icon: Weight, color: "#14b8a6", unit: "lbs", description: "Daily weigh-ins & trends" },
