...
export const CATEGORY_THEME: Record<CategoryKey, CategoryTheme> = {
  calories: { key: "calories", label: "Calories", href: hubExpandHref("calories"), icon: Flame, color: "#ef4444", unit: "cal", description: "Track meals & macros" },
  steps: { key: "steps", label: "Steps", href: hubExpandHref("steps"), icon: Footprints, color: "#22c55e", unit: "steps", description: "Daily step count" },
  running: { key: "running", label: "Running", href: "/running", icon: PersonStanding, color: "#3b82f6", unit: "mi", description: "Distance, time & pace" },
  workouts: { key: "workouts", label: "Workouts", href: hubExpandHref("workouts"), icon: Dumbbell, color: "#c4d632", unit: "sessions", description: "Log your sessions" },
  sleep: { key: "sleep", label: "Sleep", href: hubExpandHref("sleep"), icon: Moon, color: "#6366f1", unit: "hrs", description: "Track rest & quality" },
  vitals: { key: "vitals", label: "Vitals", href: hubExpandHref("vitals"), icon: HeartPulse, color: "#f43f5e", unit: "bpm", description: "Heart rate, HRV & zones" },
  peptides: { key: "peptides", label: "Peptides", href: hubExpandHref("peptides"), icon: Syringe, color: "#94a3b8", unit: "mg", description: "Reta doses & appetite" },
  bowel: { key: "bowel", label: "Bowel", href: "/bowel", icon: CircleDot, color: "#92400e", unit: "", description: "Bristol scale tracking" },
  recovery: { key: "recovery", label: "Recovery", href: hubExpandHref("vitals"), icon: Activity, color: "#2dd4bf", unit: "/10", description: "Muscle load from training" },
  alcohol: { key: "alcohol", label: "Alcohol", href: "/alcohol", icon: Beer, color: "#f59e0b", unit: "units", description: "Log drinks & units" },
  weight: { key: "weight", label: "Weight", href: hubExpandHref("weight"), icon: Weight, color: "#14b8a6", unit: "lbs", description: "Daily weigh-ins & trends" },
