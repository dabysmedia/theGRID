...
export function BottomNav() {
  ...
  return (
    <>
      ...
      >
        <div className="mb-2 flex max-w-full flex-row items-stretch justify-end">
          <div className="glass-frost hud-corners relative flex w-fit max-w-[min(100vw-1.5rem,calc(42rem+3.5rem))] flex-row-reverse overflow-hidden rounded-2xl shadow-lg shadow-black/40">
            <div
              className={cn(
                "absolute top-0 left-4 right-4 h-px bg-gradient-to-r from-transparent via-primary/25 to-transparent transition-opacity duration-300 motion-reduce:transition-none",
