  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 animate-fade-up">
        <div className="glass p-3 space-y-0.5 hud-corners" style={{ borderRadius: "4px" }}>
      ...
      <section className="glass p-5 lg:p-6 space-y-4 animate-fade-up stagger-1" style={{ borderRadius: "4px" }}>
      ...
      <section className="glass p-5 lg:p-6 space-y-4 animate-fade-up stagger-2" style={{ borderRadius: "4px" }}>
        <div className="flex items-center gap-2">
      ...
      <section className="animate-fade-up stagger-3">
        ...
        <div className="glass overflow-hidden" style={{ borderRadius: "4px" }}>
          {recent.length === 0 ? (
